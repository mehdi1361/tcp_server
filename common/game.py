...
class Battle(object):
    ...
    def turn_sequence(self, player1_info, player1_troops_info, player2_info, player2_troops_info):
        ...
        temp_player_list.extend(create_list_with_key(player_2_list, 'odd'))
        temp_player_list = sorted(temp_player_list, key=lambda k: k['index'])
        result = [k['item'] for k in temp_player_list]
    ...
    def party_creator(self):
        ...
        if self.player2.is_bot:
            ...
            print "strike", self.player1.player_client.profile.strike,
            print "beginner", self.player1.is_beginner
    ...
    def chakra_check(self):
        try:
            ...
            if selected_hero is not None:
                ...
                dec_z = float(int(round(selected_hero[0]['health'])) / int(round(selected_hero[0]['maxHealth'])))
